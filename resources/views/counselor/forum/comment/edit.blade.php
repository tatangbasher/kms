            ...
            <div class="dashboard-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="/admin/forum/comment/update/{{ $single_comment->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card mt-2">
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <textarea type="text" class="form-control" name="body" rows="4" cols="50" required>{{ $single_comment->body }}</textarea>
                                    </div>
                                  </div> 
                                </div>
                                <div class="row">
