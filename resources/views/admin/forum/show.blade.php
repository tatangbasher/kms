            ...
            <div class="dashboard-content">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="col-md-8 card my-2">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <a href="/admin/forum/comment/edit/{{ $comment->id }}">
                                                <span class="text-warning mr-2"><i class="fa fa-edit"></i></span>
                                            </a>
                                            <form action="/admin/forum/destroy/comment/{{ $comment->id }}" method="POST">
                                                @csrf
                                                @method('delete')
                        ...
                        <form action="/admin/forum/comment/store/{{ $post->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card mt-2">
                              <div class="card-body">
                                <div class="row">
